...
zooAnimals.map(function(animal) {
  return animal.animal_name.toLowerCase().split(',')
})
...
largerPopulation = zooAnimals.filter(function(animal) {
...
populationTotal = zooAnimals.reduce(function(total, population) {
